    ...
    <div className='bg-background min-h-screen text-foreground selection:bg-primary/20'>
      ...
      <section className='relative min-h-[calc(100vh-160px)] flex items-center justify-center overflow-hidden pt-20'>
        <div className='absolute inset-0 z-0'>
          <div className='absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(59,130,246,0.07),rgba(255,255,255,0)_70%)]' />
          <div
        ...
        >
          ...
          <div className='glass-card p-8 md:p-12'>
            ...
            <Link
              href='/'
              className='group inline-flex items-center gap-2 px-8 py-4 bg-primary text-white font-bold font-display uppercase tracking-wider hover:scale-105 transition-transform duration-300 shadow-lg shadow-primary/20'
            >
