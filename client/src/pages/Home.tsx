  ...
  return (
    ...
    >
      ...
      <div className='absolute inset-0 z-0'>
        <div className='absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(59,130,246,0.05),rgba(255,255,255,0)_70%)]' />
      ...
      <div className='relative z-10 container mx-auto px-6 text-center'>
        ...
        >
          ...
          <h1 className='font-display font-bold leading-[0.95] md:leading-none mb-6 text-slate-900 max-w-5xl mx-auto'>
            ...
            <span className='block text-[clamp(2.2rem,12vw,6rem)] wrap-break-word text-transparent bg-clip-text bg-linear-to-r from-primary via-blue-600 to-secondary text-glow'>
      ...
      >
        ...
        <div className='w-px h-12 bg-linear-to-b from-slate-300 to-transparent' />
      </motion.div>
    </section>
  );
}
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          {features.map((feature, idx) => (
            ...
            >
              ...
              {/* Hover Glow Effect */}
              <div className='absolute bottom-0 left-0 w-full h-1 bg-linear-to-r from-transparent via-primary to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
            </motion.div>
          ))}
        </div>
      </div>
...
function ParallaxDivider() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className='text-5xl md:text-8xl font-display font-bold text-transparent bg-clip-text bg-linear-to-b from-slate-900 to-slate-900/0 tracking-tighter'>
          SYNTHETIC
          <br />
          EVOLUTION
        </h2>
...
function NewsletterSection() {
  ...
  return (
    <section id='newsletter' className='py-32 relative overflow-hidden'>
      ...
      <div className='absolute inset-0 bg-linear-to-b from-slate-50 to-background z-0' />
      ...
      <div className='max-w-4xl mx-auto px-6 relative z-10'>
        <div className='glass p-12 md:p-16 rounded-3xl border border-slate-200 text-center relative overflow-hidden'>
          {/* Decorative lines */}
          <div className='absolute top-0 left-0 w-20 h-px bg-primary' />
          <div className='absolute top-0 left-0 w-px h-20 bg-primary' />
          <div className='absolute bottom-0 right-0 w-20 h-px bg-primary' />
          <div className='absolute bottom-0 right-0 w-px h-20 bg-primary' />
